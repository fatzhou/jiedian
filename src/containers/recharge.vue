    ...
    <div class="protocol-content" v-if="showRechargeProtocol">
      <div class="main-content">
        ...
        <div class="scroll-content">
          <div class="sub-content">尊敬的用户，为保障您的合法权益，请您在充值前仔细阅读本《充值协议》（“本协议”）以了解BY街电的充值及余额使用规则并避免产生任何误解。当您点击“确认支付”按钮，即视为您已阅读、理解本协议，并同意按照本协议约定的规则进行充值或使用账户余额。</div>
          <div class="sub-title">1. 定义：</div>
          <div class="sub-content">充值本金：您通过“BY街电”公众号账号实际支付的金额。</div>
          ...
          <div class="sub-content">您完全理解并同意，BY街电所提供的推荐好友赚提成仅适用于正当、合法按照《用户协议》使用我们服务的用户。一旦发现您的用户帐号存在任何利用前述规则从事作弊行为以获取不正当经济利益的情形，BY街电有权追回因作弊行为取得的所有不正当的经济利益，并且BY街电保留停止向您提供服务以及根据作弊行为的严重程度进一步追究法律责任的权利。</div>
          <div class="sub-title">5. 特别说明：</div>
          <div class="sub-content">您完全理解并同意，BY街电有权随时修改本协议内容，届时将通过本软件上公布修改后的协议，该公布将被视为BY街电已通知用户；同时，BY街电也可通过其他适当方式通知用户。如果您选择继续充值即表示您同意并接受修改后的协议并受其约束；如果您不同意本公司对本协议的修改，请立即放弃充值或停止使用本服务。在适用法律法规允许的范围内，本协议下充值账户余额的使用规则的最终解释权归BY街电所有。</div> 
        </div>  
      </div>
    </div>
    <div class="protocol-content" v-if="showUseProtocol">
        <div class="main-content">
          ...
          <div class="scroll-content">
            ...
            <div class="sub-content">1.1本《搏壹科技-共享充电宝租赁服务协议》（以下简称《协议》）是服务使用人（以下简称“用户”）与深圳市搏壹科技有限公司（以下简称“本公司”）之间关于用户关注、使用、管理“BY街电”公众服务号和“BY街电+”小程序软件账号，以及使用本公司提供的相关服务所订立的协议。“BY街电”公众服务号和“BY街电+”小程序软件（以下简称“本软件”）。</div>
            ...
            <div class="sub-title">“BY街电+”服务使用及管理规定</div>
            ...
            <div class="sub-content">7.2 在不透露单个用户隐私资料的前提下，本公司有权对整个用户数据库进行分析并对用户数据库进行商业上的使用。本公司《BY街电隐私政策》作为本协议的有效组成部分，且用户同意并接受本公司不定时的更新隐私政策，如用户不接受现行的或更新后的隐私政策，则应立即停止使用本服务。</div> 
